...
FILE_NO_NAMES=filedialog.askopenfilename(title="input rivers without names", filetypes = files, defaultextension = files)
FILE_NAMES=filedialog.askopenfilename(title="input file rivers with names", filetypes = files, defaultextension = files)
OUT_FILE_TMP=filedialog.asksaveasfile(title="output file merged rivers with Strahler", filetypes = files, defaultextension = files)
